...
parser.add_argument('--root_path', default='/home/fxy/project/OVLAFND/weibo_enhance/')
...
parser.add_argument('--fold_dir', type=str, default='/home/fxy/project/OVLAFND/weibo_enhance/experiments/test_政治', help='当前实验的数据文件夹路径')
